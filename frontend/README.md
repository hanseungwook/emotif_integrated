...
6. **Working example app** - Working app with Material UI design.
7. **JWT** - User Authentication already implemented and easy to get rid of.
...
| [JWT](https://github.com/tymondesigns/jwt-auth)| Glues all this together in a handy automated build. |
